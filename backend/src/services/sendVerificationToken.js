...
export const sendVerificationToken = asyncHandler(async(req,res)=>{
    try {
        ...
        const emailResponse = await sendEmail(
            ...
            `Click on the link to verify your account: <a href="http://localhost:3000/verify/${userWithToken.verificationToken}">Verify Account</a>`,
           `<p>Click on the link to verify your account: <a href="http://localhost:3000/verify/${userWithToken.verificationToken}">Verify Account</a></p>`
        )
